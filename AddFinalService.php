                              ...
                              <form  action="addFinalWorkingSite.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
                                 <div class="card-body card-block">
                                    ...
                                    <div class="row form-group">
                                       ...
                                       <div class="col-9 col-md-9"><input type="text" id="Name" name="Name" placeholder="Enter the name" class="form-control" required></div>
                                    </div>
                                    <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Description </label></div>
                                       <div class="col-9 col-md-9" style="margin: 10;"><textarea id="Description" name="Description" rows="9" placeholder="Description..." class="form-control" required></textarea></div>
                                    </div>
                                    <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">At price sendit bought</label></div>
                                       <div class="col-9 col-md-9"><input type="text" id="MRP" name="MRP" placeholder="Price in R" class="form-control" required></div>
                                    </div>
                                    <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">sendit Selling Price to customer</label></div>
                                       <div class="col-9 col-md-9"><input type="number" id="Price" name="Price" placeholder=" Price in R" class="form-control" required></div>
                                    </div>
                                    <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Discount on product</label></div>
                                       <div class="col-9 col-md-9"><input type="text" id="Discount" name="Discount" placeholder="Discount in R" class="form-control" required></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                       ...
                                       <div class="col-9 col-md-9" style="color: red;">   <input name="photo" type="file" id="takePictureField" accept="image/*" required /></div>
                                    </div>
                                    <div class="row form-group">
                                       <div class="col col-md-3"><label for="text-input" class=" form-control-label" style="color: green;">Bulk Upload (Excel file)</label></div>
                                       <div class="col-9 col-md-9" style="color: red;">   <input name="bulk" type="file" id="bulk" accept=".csv"  /></div>
                                    </div>
