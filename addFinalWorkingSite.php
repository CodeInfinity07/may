...
if (isset($_POST['IDSubsubmenu']))
{
    ...
    $target_path = "http://3.17.188.183/sendit/Dashboard/products/" . basename($_FILES['bulk']['name']);
    ...
    if (!empty($bulk))
    {
        ...
        if ($error == 0)
        {
            ...
            header('Location: http://3.17.188.183/sendit/Dashboard/AddFinalService.php?id=' . $id);
        }
        else
        {
            $_SESSION["error"] = 2;
    ...
    else
    {
        ...
        $target_path = "http://3.17.188.183/sendit/Dashboard/products/" . basename($_FILES['photo']['name']);
...
else
{
    $_SESSION["error"] = 1;
    $response['error'] = false;
    header('Location: http://3.17.188.183/sendit/Dashboard/AddFinalService.php');
